package com.example.codingevents.config;

import com.example.codingevents.repository.UserRepository;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf().disable()
                .authorizeHttpRequests(authConfig -> {
                    ...
                    authConfig.requestMatchers(HttpMethod.GET, "/tags/create", "/tags/index", "/tags").hasAuthority("USER");
                    authConfig.requestMatchers(HttpMethod.POST, "/tags/create", "/tags/index", "/tags").hasAuthority("USER");
                    authConfig.requestMatchers(HttpMethod.GET, "/eventCategories/create", "/eventCategories/index", "/eventCategories").hasAuthority("USER");
                    authConfig.requestMatchers(HttpMethod.POST, "/eventCategories/create", "/eventCategories/index", "/eventCategories").hasAuthority("USER");
                    authConfig.requestMatchers(HttpMethod.GET, "/events/create", "/events/index", "/events", "/events/add-tag", "/events/delete", "events/detail").hasAuthority("USER");
                    authConfig.requestMatchers(HttpMethod.POST, "/events/create", "/events/index", "/events", "/events/add-tag", "/events/delete", "events/detail").hasAuthority("USER");
